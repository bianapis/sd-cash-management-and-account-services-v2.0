...
@BianRestController
public class CashManagementAndAccountServicesApiController {

	@Autowired
	CashManagementAndAccountServicesApiService service;
	
	@Fulfill.Activate
	public BianResponse<SDCashManagementAndAccountServicesActivateOutputModel> activate(@RequestBody BianRequest<SDCashManagementAndAccountServicesActivateInputModel> bianRequest) {
		return BianResponse.forSuccess(service.activate(bianRequest.getData()));
	}
	
	@Fulfill.Configure
	public BianResponse<SDCashManagementAndAccountServicesConfigureOutputModel> configure(@PathVariable("sd-reference-id") String sdReferenceId, @RequestBody BianRequest<SDCashManagementAndAccountServicesConfigureInputModel> bianRequest) {
		return BianResponse.forSuccess(service.configure(sdReferenceId, bianRequest.getData()));
	}
	
	@Fulfill.Control
	public BianResponse<CRCashManagementAndAccountServicesFulfillmentArrangementControlOutputModel> control(@PathVariable("sd-reference-id") String sdReferenceId, @PathVariable("cr-reference-id") String crReferenceId, @RequestBody BianRequest<CRCashManagementAndAccountServicesFulfillmentArrangementControlInputModel> bianRequest) {
	...
	@BQ("positivepay")
	@Fulfill.Execute
	public BianResponse<BQPositivePayExecuteOutputModel> executePositivepay(@PathVariable("sd-reference-id") String sdReferenceId, @PathVariable("cr-reference-id") String crReferenceId, @PathVariable("bq-reference-id") String bqReferenceId, @RequestBody BianRequest<BQPositivePayExecuteInputModel> bianRequest) {
		return BianResponse.forSuccess(service.executePositivepay(sdReferenceId, crReferenceId, bqReferenceId, bianRequest.getData()));
	}
	...
	@Fulfill.Feedback
	public BianResponse<SDCashManagementAndAccountServicesFeedbackOutputModel> feedback(@PathVariable("sd-reference-id") String sdReferenceId, @RequestBody BianRequest<SDCashManagementAndAccountServicesFeedbackInputModel> bianRequest) {
		return BianResponse.forSuccess(service.feedback(sdReferenceId, bianRequest.getData()));
	}
	
	@Fulfill.Initiate
	public BianResponse<CRCashManagementAndAccountServicesFulfillmentArrangementInitiateOutputModel> initiate(@PathVariable("sd-reference-id") String sdReferenceId, @RequestBody BianRequest<CRCashManagementAndAccountServicesFulfillmentArrangementInitiateInputModel> bianRequest) {
	...
	@Fulfill.Retrieve
	public BianResponse<CRCashManagementAndAccountServicesFulfillmentArrangementRetrieveOutputModel> retrieve(@PathVariable("sd-reference-id") String sdReferenceId, @PathVariable("cr-reference-id") String crReferenceId) {
	...
	@BQ("positivepay")
	@Fulfill.Retrieve
	public BianResponse<BQPositivePayRetrieveOutputModel> retrievePositivepay(@PathVariable("sd-reference-id") String sdReferenceId, @PathVariable("cr-reference-id") String crReferenceId, @PathVariable("bq-reference-id") String bqReferenceId) {
		return BianResponse.forSuccess(service.retrievePositivepay(sdReferenceId, crReferenceId, bqReferenceId));
	}
	...
	@Fulfill.RetrieveSD
	public BianResponse<SDCashManagementAndAccountServicesRetrieveOutputModel> retrieveSD(@PathVariable("sd-reference-id") String sdReferenceId) {
		return BianResponse.forSuccess(service.retrieveSD(sdReferenceId));
	}
	
	@Fulfill.Update
	public BianResponse<CRCashManagementAndAccountServicesFulfillmentArrangementUpdateOutputModel> update(@PathVariable("sd-reference-id") String sdReferenceId, @PathVariable("cr-reference-id") String crReferenceId, @RequestBody BianRequest<CRCashManagementAndAccountServicesFulfillmentArrangementUpdateInputModel> bianRequest) {
